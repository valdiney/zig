<div class="sidebar-wrapper">
  <ul class="nav">
    ...
    <li class="">
      <a href="<?php echo BASEURL; ?>/home/index" class="<?php currentRouteFromMenu('home/index', 'inicioBorder'); ?>">
    ...
    <li class="">
      <?php if ($configPdv->id_tipo_pdv == 1) : ?>
        <a href="<?php echo BASEURL; ?>/pdvPadrao/index" class="<?php currentRouteFromMenu('pdvPadrao/index', 'pdvBorder'); ?>">
      ...
      <?php elseif ($configPdv->id_tipo_pdv == 2) : ?>
        <a href="<?php echo BASEURL; ?>/pdvDiferencial/index" class="<?php currentRouteFromMenu('pdvDiferencial/index', 'pdvBorder'); ?>">
          <i class="fas fa-coins" style="color:#00cc99"></i>
    ...
    <li class="">
      <a href="<?php echo BASEURL; ?>/produto/index" class="<?php currentRouteFromMenu('produto/index', 'produtoBorder'); ?>">
    ...
    <li class="">
      <a href="<?php echo BASEURL; ?>/cliente/index" class="<?php currentRouteFromMenu('cliente/index', 'clienteBorder'); ?>
    ...
    <li class="">
      <a href="<?php echo BASEURL; ?>/pedido/index" class="<?php currentRouteFromMenu('pedido/index', 'pedidoBorder'); ?>">
    ...
    <li class="">
      <a href="<?php echo BASEURL; ?>/relatorio/vendasPorPeriodo" class="<?php currentRouteFromMenu('relatorio/index', 'relatorioBorder'); ?> 
