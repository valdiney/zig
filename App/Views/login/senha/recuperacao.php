...
<form class="form-signin" method="post" action="<?php echo BASEURL . "/login/senha/recuperacao/{$hash}"; ?>">
  ...
  <div class="form-label-group">
    <input type="password" id="password" name="password" class="form-control" placeholder="Sua nova senha" required autofocus>
    <label for="password">Nova senha</label>
  </div>

  <div class="form-label-group">
    <input type="password" id="password_check" name="password_check" class="form-control" placeholder="Repita a senha" required>
