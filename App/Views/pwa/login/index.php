...
<head>
  ...
  <meta name="theme-color" content="#2dd1ac">
	...
	<style>
	    #card-login{margin-top:10%;background:0 0;border:0!important;box-shadow:0 0 0}#button-entrar{background:#22b7c1;color:#fff;font-weight:700;border:0}body{background:#3c9}body,html{height:100%}.card-body{border:0!important;border-right:0}.close-modal{display:none!important}
	</style>
        ...
        <div class="col-md-12">
          ...
          <div class="card" id="card-login">
            <div class="card-body">
              ...
              <center><h2 style="color:white;">ZigMoney</h2></center> <br>
