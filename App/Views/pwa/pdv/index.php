...
<head>
	...
	<style>
	    body{background:#fff;color:#444d5d}body,html{height:100%}.card{margin-top:30px;box-shadow:#cbcdc9 1px 1px 5px}.card h3{color:#444d5d}.col-lg-12{padding:0}.card{border:0;border-radius:0;box-shadow:#fff 1px 1px 1px}.list-group li{border-left:0!important;border-right:0!important;border-bottom:0!important;width:100%important}.the-my-circle{width:60px;float:right}.img-perfil{float:left;width:40px;border-radius:50%;margin-right:10px;margin-top:10px}.theShow{display:block!important}.theNone{display:none!important}#menu{background:#fff;position:absolute;z-index:2000000;height:100%;display:none}.brand{padding:2px;background:#f2f4f5;border-radius:5px;border:1px solid #2dd1ac}
	</style>
...
<body>
	...
	<div class="col-lg-12" id="menu">
		<ul class="list-group">
		  <li class="list-group-item" disabled style="opacity:0.40">Realizar vendas <small class="brand">Em breve</small></li>
			...
			<div class="col-lg-12" style="padding:10px">
                ...
                <center>
				    ...
				    <button class="btn" style="border:1px solid #d9dce1;margin-left:10px">
	                	<i class="fas fa-chevron-right" style="float:left;line-height:30px;opacity:0.80" id="btn-mes-proximo"></i> 
	                </button>
                </center>
