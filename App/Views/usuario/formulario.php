  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="nome" id="nome" placeholder="Digite o nome do usuário!" value="<?php echo isset($usuario->id) ? $usuario->nome : '' ?>">
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <input type="password" class="form-control" name="password" id="password" placeholder="Digite a senha" value="">
      </div>
    </div>
        ...
        <select class="form-control" name="id_sexo" id="id_sexo">
          ...
          <?php foreach ($sexos as $sexo) : ?>
            <?php if (isset($usuario->id) && $usuario->id_sexo == $sexo->id) : ?>
              <option value="<?php echo $usuario->id_sexo; ?>" selected="selected"><?php echo $sexo->descricao; ?>
              </option>
            <?php else : ?>
